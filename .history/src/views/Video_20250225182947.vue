      ...
      <div class="scrollable-container" @scroll="handleScroll">
        ...
        <div v-else>
          <div class="grid grid-cols-2 gap-4">
            <div v-for="video in filteredVideos" :key="video.id" class="video-item bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer" @click="goToVideo(video.id)">
